...
$GLOBALS['TL_LANG'][$strName]['fields']['content_display_viewport'] = ['Displaygröße',''];

$GLOBALS['TL_LANG']['tl_content']['content_bgcolor'] = ['Hintergrundfarbe','Hintergrundfarbe des Elements'];
$GLOBALS['TL_LANG'][$strName]['fields']['content_bgcolor_type'] = ['Hintergrundfarbe',''];
